...
import { index, getVehicleById, setVehicleCountById, updateVehicleCountById, getStarshipById, updateStarshipCountById, setStarshipCountById } from 'api/controller'
